...
const supplierCategories = [
  "Food & Beverages", "Fresh Produce", "Meat & Poultry", "Seafood", "Dairy",
  "Bakery", "Beverages", "Wine & Spirits", "Equipment & Supplies", 
  "Cleaning & Sanitation", "Technology", "Linens & Uniforms", 
  "Furniture & Decor", "Packaging", "Marketing & Design", "Consulting"
];
...
export function SupplierOnboarding({ userId, onComplete }: SupplierOnboardingProps) {
  ...
  const handleComplete = async () => {
    ...
    if (supplierError) {
      setLoading(false);
      toast({ variant: "destructive", title: "Error", description: supplierError.message });
      return;
    }

    // Create offers
    const validOffers = offers.filter((o) => o.title.trim());
    if (validOffers.length > 0 && supplierData) {
      const { error: offersError } = await supabase.from("supplier_offers").insert(
      ...
      <Card className="border-border/50 shadow-lg">
        <CardContent className="p-6">
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">What do you offer and where?</p>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {coverageAreas.map((area) => (
                      <Badge
                        key={area}
                        variant={formData.coverageAreas.includes(area) ? "default" : "outline"}
                        className="cursor-pointer transition-colors"
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                <h2 className="font-heading text-xl font-semibold">Your Offers</h2>
                <p className="text-muted-foreground">Add up to 3 products or services</p>
              </div>
          ...
          {currentStep === 4 && (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-8">
                Your supplier profile is ready. Start connecting with restaurants.
              </p>
