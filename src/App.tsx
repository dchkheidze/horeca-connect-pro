    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/r" element={<DashboardLayout role="restaurant" />}>
          ...
          <Route path="/s" element={<DashboardLayout role="supplier" />}>
            <Route path="dashboard" element={<SupplierDashboard />} />
            <Route path="leads" element={<div className="p-4">Leads Management - Coming Soon</div>} />
            <Route path="profile" element={<div className="p-4">Profile Editor - Coming Soon</div>} />
            <Route path="settings" element={<div className="p-4">Settings - Coming Soon</div>} />
          </Route>

          {/* Job Seeker dashboard routes */}
          <Route path="/j" element={<DashboardLayout role="jobseeker" />}>
